...
The current development preview is [v0.3.0](docs/releases/v0.3.0.md). It is intended for testing and contributor feedback, not production camera workflows.
