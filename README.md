...
- Camera-style orientation that keeps capture and settings geometry fixed and makes every sensor sample honor Android's system auto-rotate setting. Complete camera identity, battery, storage, compact controls, and scrollable settings content rotate inside stable slots; longer copy and settings swap measurement axes before rotation so they reflow against the full available space instead of being abbreviated or moving the outer layout.
- REC start/stop
