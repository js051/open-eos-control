...
The current development preview is [v0.7.0](docs/releases/v0.7.0.md). It is intended for testing and contributor feedback, not production camera workflows.

This preview adds Android camera-reported AF frames and corrects remote Live View stop/resume behavior. PC and iOS are version-aligned only; these Android changes are not implemented on those clients. Camera-side manual-focus reliability remains under investigation.
