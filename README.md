...
The current development preview is [v0.1.10](docs/releases/v0.1.10.md). It is intended for testing and contributor feedback, not production camera workflows.
