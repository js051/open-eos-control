...
目前的開發預覽版為 [v0.7.0](docs/releases/v0.7.0.md)，用途是測試與收集貢獻者回饋，不建議用於正式拍攝流程。

本版新增 Android 相機回報的 AF 框與狀態，並修正遠端 Live View 停止／恢復行為。PC 與 iOS 只對齊版本，尚未同步這輪 Android 變更；機身手動拍攝容易失焦的原因仍在調查。
