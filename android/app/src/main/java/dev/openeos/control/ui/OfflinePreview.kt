...
internal fun CameraUiState.withOfflinePreview(): CameraUiState = copy(
    ...
    capabilities = CameraCapabilities(
        ...
        advancedSettings = listOf(
            ...
            CameraSettingControl("autopoweroff", "Auto power off", "180", listOf("30", "60", "120", "180", "300", "600", "disable")),
            ...
            CameraSettingControl("directoryselection", "Capture directory", "100EOSXX", listOf("100EOSXX", "101EOSXX")),
    ...
    mediaItems = listOf(
        ...
        CameraMediaItem(
            ...
            contentType = "video/mp4", widthPixels = 3840, heightPixels = 2160,
        ),
    ),
