...
fun buildDiagnosticReport(
    ...
    val report = buildString {
        ...
        appendLine("latestMediaRequestLimit=$CAPTURE_REVIEW_REQUEST_ITEMS")
        appendLine("latestMedia=${if (state.captureReviewItem == null) "none" else "available"}")
        appendLine("latestMediaThumbnail=${if (state.captureReviewThumbnail == null) "none" else "available"}")
