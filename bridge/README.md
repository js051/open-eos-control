...
This package provides the PC camera backend and browser control surface for Open EOS Control 0.1.0.
...
```bash
python -m pip install open_eos_control_bridge-0.1.0-py3-none-any.whl
```
