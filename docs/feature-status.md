...
| iOS CCAPI app | Implemented; device validation required | iOS 17 SwiftUI app reaches the native core for connection, capability-gated controls, JPEG Live View, capture/record/focus, media transfer/confirmed deletion, and diagnostics; English/Traditional Chinese, offline preview, safe orientation behavior, app unit tests, and three iPhone Simulator UI workflows are CI-gated; record a physical iPhone/R6 Mark III result |
