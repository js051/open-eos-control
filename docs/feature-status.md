...
| Android Canon EOS vendor exposure/settings | Research | Vendor property codes, data types, value mappings and state transitions are proven by authoritative documentation or recorded R6 Mark III traces |
