...
- Decoded JPEG/Bridge Live View monitoring assists with a bounded 120x80 background analysis path for a mutually exclusive histogram or 64x64 luma waveform, configurable zebra, false color and focus peaking, plus geometry-only frame guides, action/title safe areas and anamorphic desqueeze. Native RTP preserves direct sample-buffer rendering, so pixel analysis is intentionally unavailable there while guides and desqueeze remain active.
