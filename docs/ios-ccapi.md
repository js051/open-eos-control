...
- Media listing, file-backed download/share with real byte progress and an accessible cancel action, a lazy details sheet for capability-gated protection/rating/rotation, confirmation deletion, redacted diagnostic report, and no fake USB/PTP action
