...
- Canon EOS USB Touch AF and remaining vendor settings beyond the implemented exposure, color, aspect-ratio, power-zoom, image-quality, AF, drive, metering and movie mappings.
- CCAPI RTP live view.
